...
volatile _Bool fRetLora,fBusy,fAT,fATerr,fParm,fDetec,fOK,fTxOk;
volatile _Bool fTimeOut,fProgID,fErroID,fLigado,fRTX;
...
uint16_t tempoEspera,tMs,cicloLED,passagem,tempoRTX;
uint8_t BatH,BatL;
uint8_t temp8,rett;
uint16_t temp16;
...
void main(void)
{
    ...
    do { LATAbits.LATA6 = 1; } while(0); do { LATAbits.LATA7 = 1; } while(0); _delay((unsigned long)((500)*(16000000/4000.0))); do { LATAbits.LATA6 = 0; } while(0); do { LATAbits.LATA7 = 0; } while(0); _delay((unsigned long)((500)*(16000000/4000.0)));
    do { LATAbits.LATA6 = 1; } while(0); do { LATAbits.LATA7 = 1; } while(0); _delay((unsigned long)((500)*(16000000/4000.0))); do { LATAbits.LATA6 = 0; } while(0); do { LATAbits.LATA7 = 0; } while(0);
    ...
    while (1)
    {
        ...
        if (fRetLora)
        {
            ...
            OFFSET = endereco_C * 100;
            OFFSET += (endereco_D * 10);
            OFFSET += endereco_U;
            ...
            if (OFFSET<10)
                TempoDeReplicacao = OFFSET + OFFSET + OFFSET;
            else
                TempoDeReplicacao = OFFSET;
...
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "0" "," "0" "," "212" "," "57" "," "222" "," "1" "," "54" "," "55");
...
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "54" "," "14" "," "212" "," "57" "," "111" "," "21" "," "8" "," "141");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "50" "," "71" "," "71" "," "70" "," "200" "," "55" "," "25" "," "33");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "102" "," "101" "," "101" "," "100" "," "100" "," "99" "," "99" "," "98");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "98" "," "97" "," "97" "," "97" "," "96" "," "96" "," "95" "," "95");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "94" "," "94" "," "93" "," "93" "," "92" "," "92" "," "92" "," "91");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "91" "," "90" "," "90" "," "89" "," "89" "," "89" "," "88" "," "88");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "87" "," "87" "," "87" "," "86" "," "86" "," "85" "," "85" "," "85");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "84" "," "84" "," "83" "," "83" "," "83" "," "82" "," "82" "," "81");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "81" "," "81" "," "80" "," "80" "," "80" "," "79" "," "79" "," "78");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "78" "," "78" "," "77" "," "77" "," "76" "," "76" "," "76" "," "75");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "75" "," "75" "," "74" "," "74" "," "73" "," "73" "," "73" "," "72");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "72" "," "71" "," "71" "," "71" "," "70" "," "70" "," "70" "," "69");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "69" "," "68" "," "68" "," "68" "," "67" "," "67" "," "66" "," "66");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "66" "," "65" "," "65" "," "64" "," "64" "," "64" "," "63" "," "63");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "62" "," "62" "," "62" "," "61" "," "61" "," "60" "," "60" "," "59");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "59" "," "59" "," "58" "," "58" "," "57" "," "57" "," "56" "," "56");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "56" "," "55" "," "55" "," "54" "," "54" "," "53" "," "53" "," "52");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "52" "," "51" "," "51" "," "50" "," "50" "," "49" "," "49" "," "48");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "47" "," "47" "," "47" "," "46" "," "46" "," "45" "," "44" "," "44");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "43" "," "43" "," "42" "," "41" "," "41" "," "40" "," "39" "," "39");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "38" "," "37" "," "37" "," "36" "," "35" "," "34" "," "33" "," "33");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "32" "," "31" "," "30" "," "29" "," "28" "," "27" "," "26" "," "25");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "75" "," "75" "," "74" "," "74" "," "73" "," "73" "," "73" "," "72");
__asm("\tpsect eeprom_data,class=EEDATA,delta=2,space=3,noexec"); __asm("\tdb\t" "50" "," "71" "," "71" "," "70" "," "200" "," "55" "," "25" "," "33");
