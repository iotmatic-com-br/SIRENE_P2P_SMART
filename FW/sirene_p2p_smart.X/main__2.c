...
////
////    JP1 JP2 JP3 JP4  
////     A   A   A   A     - default 'E' = modelo antigo
////     A   A   A   A     
////     A   A   A   A
////     A   A   A   A
////     A   A   A   A
...
volatile  uint8_t   fRetLora,indice,GRUPO;
...
void main(void)
{
    ...
    while (1)
    {
        ...
        //////////////////////// check radio lora
        if (fRetLora==1)            // Recebeu 'DadosLora[14] == 'E', modelo antigo
        {
            TrataModeloAntigo();
        ...
        else if (fRetLora==2)            // Recebeu 'DadosLora[14] diferente de 'E'.
        {                                //    Esperado entre '0' e '9'
            if ( (GRUPO >= '0')&&(GRUPO <= '9') )
                TrataModeloNovo();
